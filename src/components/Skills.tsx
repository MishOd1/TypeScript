...
const Skills = () => {
    ...
    const Play = require("../assets/playw.png")
    const Vite = require("../assets/vite.png")
  return (
    <div id='skills111' className='w-full h-screen bg-[#15243f] text-gray-300'>
      {/* Container */}

      <div className='max-w-[65%] ml-[17.5%] mx-auto p-4 flex text-center flex-col justify-center w-full h-full'>
          <div>
          ...
          <div className='w-full grid grid-cols-2 sm:grid-cols-5 gap-4 text-center py-8'>
              ...
              <div className='shadow-md bg-[#0a192f] shadow-[#040c16] hover:scale-110 duration-500  hover:shadow-[#53d8e96c]'>
                  <img className='w-[50%] mx-auto' src={Play} alt="HTML icon" />
                  <p className='my-6'>PlayWright.JS</p>
              </div>
              <div className='shadow-md bg-[#0a192f] shadow-[#040c16] hover:scale-110 duration-500  hover:shadow-[#53d8e96c]'>
                  <img className='w-[40%] mx-auto' src={Vite} alt="HTML icon" />
